...
const COMPANIES = [
  { slug: 'fundco-ng', token: 'FUNDCO_NG' },
  { slug: 'onecapinvestment-ng', token: 'ONECAPINVESTMENT_NG' },
  ...
  { slug: 'cleanenergyfund-ng', token: 'CLEANENERGYFUND_NG' },
  { slug: 'meshworks-ng', token: 'MESHWORKS_NG' },
  { slug: 'greenkiosk-ng', token: 'GREENKIOSK_NG' },
];
...
(async () => {
  ...
  for (const { slug, token } of COMPANIES) {
    ...
    await page.screenshot({
      ...
      clip: { x: 0, y: 0, width: 600, height: Math.ceil(height) + 4 },
    });
